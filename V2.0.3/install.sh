...
curl https://raw.githubusercontent.com/HuskyHunk/JIOTVServer/main/V2.0.3/JTVServer.zip -o JTVServer.zip
...
cd ~
curl -o start.sh https://raw.githubusercontent.com/HuskyHunk/JIOTVServer/main/V2.0.3/start.sh
if [ $? -eq 0 ]; then
   echo "Script downloaded successfully"
else
    echo "Failed to download start script. Please run wget https://raw.githubusercontent.com/HuskyHunk/JIOTVServer/main/V2.0.3/start.sh to download"
    exit 1
fi
